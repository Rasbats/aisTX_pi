...
set wxWidgets_ROOT_DIR=D:\Documents\MyRIS\aisTX_pi\cache\wxWidgets-3.2.1
set wxWidgets_LIB_DIR=D:\Documents\MyRIS\aisTX_pi\cache\wxWidgets-3.2.1\lib\vc14x_dll
